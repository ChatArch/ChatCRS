...
EXPECTED_CLI_LEAVES = {
    ...
    "chatcrs admin accounts codex usage",
    "chatcrs admin accounts codex credits",
    "chatcrs admin accounts codex consume",
    "chatcrs admin accounts codex operation",
...
EXPECTED_HTTP_INTERFACES = {
    ...
    "GET /admin/openai-accounts/{account_id}/codex/usage",
    "GET /admin/openai-accounts/{account_id}/codex/reset-credits",
    "POST /admin/openai-accounts/{account_id}/codex/reset-credits/consume",
    "GET /admin/openai-accounts/{account_id}/codex/reset-credits/operations/{request_id}",
