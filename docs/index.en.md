...
| Codex direct usage | `chatcrs codex account`, `chatcrs codex quota`, `chatcrs codex usage` | Direct OpenAI/Codex account and usage/quota inspection with redacted output |
